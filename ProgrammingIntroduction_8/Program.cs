...
Console.WriteLine("Please provide your integer input, with possible errors");
...
// example 6 - method
Console.WriteLine("Please provide your decimal input");
income = Convert.ToDecimal(Console.ReadLine());
